...
RESULT_GERAL <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
                           sheet = "RESUMODADOS") 
...
RESULT_INSIGNE <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
                             sheet = "INSIGNE") 
...
RESULT_INSIGNE2 <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
                              sheet = "INSIGNE2") 
...
RESULT_REBATES <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
                             sheet = "REBATES") 
...
OUTRAS_CAMPANHAS <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
...
RETROATIVOS <- read_sheet("1-rIFHbJqanoLizZmZ0Xuyq6VZAyiEgud9_6dDjcLee0",
                          sheet = "RETROATIVOS") 

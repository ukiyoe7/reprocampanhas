...
CP_849_0722 %>% summarize(v=sum(VRVENDA))

CP_849_0722 %>% summarize(v=sum(VRVENDA)*0.08)

## OBS
OBS_849 <-paste0("VITAL ","G",CP_849_0722  %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))



## LISTA PEDIDOS
LIST_849_0722 <- CP_849_0722 %>% 
  mutate(CPF=rep(c("04455447911","06532582913"), length.out=nrow(CP_849_0722))) %>% 
  mutate(OBS=OBS_849)
...
PAG_849_0722 <- LIST_849_0722 %>% group_by(CPF) %>% 
...
CP_1419_0722 %>% summarize(v=sum(BONUS))

## OBS


OBS_1419 <- paste0("LOOK ",CP_1419_0722  %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


## JOIN CPF

LIST_1419_0722 <- inner_join(CP_1419_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1419)
...
PAG_1419_0722 <- LIST_1419_0722 %>%  group_by(CPF) %>% 
...
CP_305_0722 %>% summarize(v=sum(BONUS))


## OBS

OBS_305 <- paste0("GARUVA ",CP_305_0722 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


## JOIN CPF

LIST_305_0722 <- inner_join(CP_305_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_305)
...
LIST_305_0722 %>% summarize(v=sum(BONUS))


### pagamentos

PAG_305_0722 <- LIST_305_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_305) 
...
PAG_305_0722 %>% summarize(v=sum(BONUS)) 
...
CP_G121_0722 %>% summarize(v=sum(VRVENDA))

CP_G121_0722 %>% summarize(v=sum(BONUS))


## OBS

OBS_G121 <- paste0("RINALDI ","G",CP_G121_0722 %>% 
                     distinct(GCLCODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G121_0722 <- inner_join(CP_G121_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G121)
...
PAG_G121_0722 <- LIST_G121_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>%
  mutate(OBS=OBS_G121) 
...
PAG_G121_0722 %>% summarize(v=sum(BONUS))
...
CP_206_0722 %>% summarize(v=sum(VRVENDA))

CP_206_0722 %>% summarize(v=sum(BONUS))


OBS_206 <-  paste0("OTICA RH ",CP_206_0722 %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 

## JOIN CPF

LIST_206_0722 <- inner_join(CP_206_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_206)
...
PAG_206_0722 <- LIST_206_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_206)
...
CP_213_0722 %>% summarize(v=sum(BONUS))

## OBS

OBS_213 <- paste0("LINO ",CP_213_0722 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))

## JOIN CPF AND LIST

LIST_213_0722 <- inner_join(CP_213_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  mutate(OBS=OBS_213) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") 
...
LIST_213_0722_2 <- LIST_213_0722 %>% distinct(.,ID_PEDIDO,.keep_all = TRUE)


## PAY

PAG_213_0722<-  LIST_213_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=sum(BONUS)/(LIST_213_0722  %>% distinct(CPF) %>% lengths())) %>% 
  mutate(OBS=OBS_213) 
...
CP_1225_0722 %>% summarize(v=sum(VRVENDA))

CP_1225_0722 %>% summarize(v=sum(BONUS))

OBS_1225 <- paste0("VINI ",CP_1225_0722 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_1225_0722  <- inner_join(CP_1225_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1225)
...
PAG_1225_0722 <- LIST_1225_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_1225) 
...
PAG_1225_0722 %>% summarize(v=sum(BONUS))
...
CP_1676_0722 %>% summarize(v=sum(VRVENDA))

CP_1676_0722 %>% summarize(v=sum(BONUS))

OBS_1676 <- paste0("ORBEN ",CP_1676_0722 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_1676_0722  <- inner_join(CP_1676_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1676)
...
PAG_1676_0722 <- LIST_1676_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_1676) 
...
PAG_1676_0722 %>% summarize(v=sum(BONUS))

## =============================================================================================================         

# SQL 4253 BLUEEYE

CP_4253_0722 <- dbGetQuery(con2,"
WITH FIS AS (SELECT FISCODIGO FROM TBFIS WHERE FISTPNATOP IN ('V','SR','R')),
...
CP_4253_0722 %>% summarize(v=sum(VRVENDA))

CP_4253_0722 %>% summarize(v=sum(BONUS))

OBS_4253 <- paste0("BLUEEYE ",CP_4253_0722 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_4253_0722  <- inner_join(CP_4253_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_4253)
...
PAG_4253_0722 <- LIST_4253_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_4253) 
...
PAG_4253_0722 %>% summarize(v=sum(BONUS))
...
CP_350_0722 %>% summarize(v=sum(VRVENDA))

CP_350_0722 %>% summarize(v=sum(BONUS))

OBS_350 <- paste0("SANTA LUZIA ",CP_350_0722 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_350_0722  <- inner_join(CP_350_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_350)
...
PAG_350_0722 <- LIST_350_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_350) 
...
PAG_350_0722 %>% summarize(v=sum(BONUS))
...
CP_788_0722 %>% summarize(v=sum(VRVENDA))

CP_788_0722 %>% summarize(v=sum(BONUS))

OBS_788 <- paste0("ASTRO ",CP_788_0722 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_788_0722  <- inner_join(CP_788_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_788)
...
PAG_788_0722 <- LIST_788_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_788) 
...
PAG_788_0722 %>% summarize(v=sum(BONUS))
...
CP_325_0722 %>% summarize(v=sum(VRVENDA))

CP_325_0722 %>% summarize(v=sum(BONUS))

OBS_325 <- paste0("MIAMI ",CP_325_0722 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_325_0722  <- inner_join(CP_325_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_325)
...
PAG_325_0722 <- LIST_325_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_325) 
...
PAG_325_0722 %>% summarize(v=sum(BONUS))

## =============================================================================================================         

# SQL G187 CRAFTS

CP_G187_0722 <- dbGetQuery(con2,"
WITH FIS AS (SELECT FISCODIGO FROM TBFIS WHERE FISTPNATOP IN ('V','SR','R')),
...
CP_G187_0722 %>% summarize(v=sum(VRVENDA))

CP_G187_0722 %>% summarize(v=sum(BONUS))

OBS_G187 <- paste0("CRAFTS ",CP_G187_0722 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G187_0722  <- inner_join(CP_G187_0722,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G187)
...
PAG_G187_0722 <- LIST_G187_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G187) 
...
PAG_G187_0722 %>% summarize(v=sum(BONUS))
...
CP_G121_2_0722 <- dbGetQuery(con2,"
WITH FIS AS (SELECT FISCODIGO FROM TBFIS WHERE FISTPNATOP IN ('V','SR','R')),
...
CP_G121_2_0722 %>% summarize(v=sum(VRVENDA))

CP_G121_2_0722 %>% summarize(v=sum(BONUS))

OBS_G121_2 <- paste0("RINALDI ","G121 ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y")) 


## JOIN CPF

LIST_CP_G121_2_0722  <- CP_G121_2_0722 %>%   mutate(OBS=OBS_G121_2)

View(LIST_CP_G121_2_0722)


### PAY

PAG_G121_2_0722 <- LIST_CP_G121_2_0722 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G121_2) 

View(PAG_G121_2_0722)


PAG_G121_2_0722 %>% summarize(v=sum(BONUS))
...
range_write(PAG_ALL_0722,ss="1_bWLe-4X_c1A6-9zst6DoBd7N1RSlwwAs5yBOdQIaX0",range = "A1",sheet="PAGAMENTOS",reformat = FALSE)  
...
LIST_ALL_0722 %>% summarize(v=sum(BONUS))

range_write(LIST_ALL_0722,ss="1_bWLe-4X_c1A6-9zst6DoBd7N1RSlwwAs5yBOdQIaX0",range = "A:P",sheet="PEDIDOS",reformat = FALSE)  

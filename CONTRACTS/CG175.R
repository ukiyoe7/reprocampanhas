...
CP_G175_0722 %>% summarize(v=sum(VRVENDA))

CP_G175_0722 %>% summarize(v=sum(BONUS))

OBS_G175 <- paste0("CHILI BEANS ",CP_G175_0722 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G175_0722  <- inner_join(CP_G175_0722,BASE_CPF,by="CLICODIGO") %>% 
...
PAG_G175_0722 <- LIST_G175_0722 %>% group_by(CPF) %>% 

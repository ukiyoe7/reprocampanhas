...
write.csv2(resumo_campanhas_out23,file ="C:\\Users\\REPRO SANDRO\\Documents\\R\\REPRO CAMPANHAS\\2023\\NOV\\RESUMO_CAMPANHAS_NOV23.csv" ,row.names = FALSE,na="")
...
write.csv2(LIST_INSIGNE_1123_ALL %>% 
             as.data.frame() %>% 
             mutate(CPF=as.character(CPF)),file ="C:\\Users\\REPRO SANDRO\\Documents\\R\\REPRO CAMPANHAS\\2023\\OUT\\LIST_INSIGNE_1123_ALL.csv" ,row.names = FALSE,na="")
...
write.csv2(LIST_VARILUX_1123 %>% 
             as.data.frame() %>% 
             mutate(CPF=as.character(CPF)),file ="C:\\Users\\REPRO SANDRO\\Documents\\R\\REPRO CAMPANHAS\\2023\\OUT\\LIST_VARILUX_1123.csv" ,row.names = FALSE,na="")
...
write.csv2(LIST_VLX_ECONO_1123 %>% 
             as.data.frame() %>% 
             mutate(CPF=as.character(CPF)),file ="C:\\Users\\REPRO SANDRO\\Documents\\R\\REPRO CAMPANHAS\\2023\\OUT\\LIST_VLX_ECONO_1123.csv" ,row.names = FALSE,na="")

...
CARTOES_1123 <- read_excel("~/CAMPANHAS/2023/NOV/CARTOES_1123.xlsx") %>% 
...
CARTOES_1123 <- CARTOES_1123 %>% `colnames<-`(cols2)


save(CARTOES_1123,file = "~/R/REPRO CAMPANHAS/2023/NOV/CARTOES_1123.RData")

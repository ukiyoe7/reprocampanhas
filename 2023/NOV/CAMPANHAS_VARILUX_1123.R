...
write.csv2(CREDITO_CARTOES_VARILUX_1123_3,
           file = "C:\\Users\\REPRO SANDRO\\OneDrive - Luxottica Group S.p.A (1)\\CAMPANHAS ALELO\\2023\\OUT\\CREDITO_CARTOES_VARILUX_1123.csv",
...
NAO_BONIFICADOS_VARILUX_1123 <-
  
  left_join(CREDITO_CARTOES_VARILUX_1123 %>% 
              filter(!is.na(NSERIE)) %>% 
...
range_write("1Fy7pehis2ZCDdy42lF3gVuKmDZhRVSSVF40W8GkKbsI",data =NAO_BONIFICADOS_VARILUX_1123,
...
VARILUX_EMISSAO_CARTOES_1123 <- CREDITO_CARTOES_VARILUX_1123 %>% 
  filter(is.na(NSERIE)) %>% 
  left_join(.,PARTICIPANTES_CAMPANHA %>% 
              mutate(CPF=as.character(CPF)),by="CPF") %>%  .[,c(1:3,11:14)] 

View(VARILUX_EMISSAO_CARTOES_1123)


range_write("1Fy7pehis2ZCDdy42lF3gVuKmDZhRVSSVF40W8GkKbsI",data =EMISSAO_CARTOES_1123,

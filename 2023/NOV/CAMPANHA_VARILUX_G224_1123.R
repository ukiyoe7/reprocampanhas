...
## VARILUX_G224_1123 ATE 31.01.2024 =============================================================================================================         
...
CARTOES_1123 <- get(load("C:\\Users\\REPRO SANDRO\\Documents\\R\\REPRO CAMPANHAS\\2023\\OUT\\CARTOES_1123.RData"))



CREDITO_CARTOES_VARILUX_G224_1123 <- left_join(PAG_VARILUX_G224_1123 %>%
...
View(CREDITO_CARTOES_VARILUX_G224_1123)
...
write.csv2(CREDITO_CARTOES_VLX_ECONO_1123_3,
           file = "C:\\Users\\REPRO SANDRO\\OneDrive - Luxottica Group S.p.A (1)\\CAMPANHAS ALELO\\2023\\OUT\\CREDITO_CARTOES_VLX_ECONO_1123.csv",
           row.names=FALSE,quote = FALSE)


left_join(CREDITO_CARTOES_1123_2,ALELO_1123 %>% rename(NSERIE=`Número de Série`),by="NSERIE") %>%.[,c(-4,-5,-6,-7,-8,-9)] %>% View()

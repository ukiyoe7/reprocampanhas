...
PAG_206_0422 <- LIST_206_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_206)
...
OBS_350 <- paste0("BLUEEYE ",CP_350_0622 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 
...
range_write(PAG_ALL_0622,ss="1GYqiPa3H-v-bt_YAzixLzD4gwHMyGEA916zabrL_RUE",range = "A1",sheet="PAGAMENTOS",reformat = FALSE)  
...
range_write(LIST_ALL_0622,ss="1GYqiPa3H-v-bt_YAzixLzD4gwHMyGEA916zabrL_RUE",range = "A1",sheet="PEDIDOS",reformat = FALSE)  

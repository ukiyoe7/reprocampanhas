...
View(CP_G139_0622)
CP_G139_0622 %>%  summarize(v=sum(VRVENDA)) # total sales
CP_G139_0622 %>%  summarize(v=sum(VRVENDA)*0.07) # vendedoras 
CP_G139_0622 %>%  summarize(v=sum(VRVENDA)*0.03) # montador
sum(CP_G139_0622 %>%  summarize(v=sum(VRVENDA)*0.07),CP_G139_0622 %>% summarize(v=sum(VRVENDA)*0.03)) #total

## OBS

OBS_G139 <- paste0("SCHROEDER ","G",CP_G139_0622 %>% 
                       distinct(GCLCODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


### Cria Planilha identificação CPFs

CP_G139_0622_IPEDIDOS <- CP_G139_0622 %>% group_by(ID_PEDIDO,PEDDTBAIXA) %>% 
  summarize(VRVENDA=sum(VRVENDA)) %>% 
  as.data.frame() %>% `colnames<-`(c("ID_PEDIDO","DATA","VALOR.VENDA")) %>% 
  mutate(DATA=format(DATA,"%d/%m/%y")) 

range_write("10OfxSBBfzkjDRhuYdYRVSO-VF1vKKCPnYb-ulPgEV10",data=CP_G139_0622_IPEDIDOS,sheet = "JUN22",
            range = "A1") 


View(CP_G139_0622_IPEDIDOS)

## obtem dados planilha identificação CPFs


CPF_G139_CPF_0622 <- read_sheet("10OfxSBBfzkjDRhuYdYRVSO-VF1vKKCPnYb-ulPgEV10",sheet = "JUN22") %>% 
  as.data.frame() %>% 
  mutate(CPF=sub("\\D+", '',CPF)) %>% 
  mutate(CPF=sub("\\.", '',CPF)) %>% 
  mutate(CPF=sub("\\-", '',CPF))

View(CPF_G139_CPF_0622)


#lista pedidos

LIST_G139_0622 <- inner_join(CP_G139_0622,CPF_G139_CPF_0622,by="ID_PEDIDO") %>% 
  mutate(OBS=OBS_G139) %>% 
  .[,c(-12,-13,-14)]

View(LIST_G139_0622)

LIST_G139_0622 %>% summarize(BONUS=sum(BONUS)) 
...
PAG_G139_0622_VENDEDORAS <- LIST_G139_0622 %>% group_by(CPF) %>% summarize(BONUS=sum(BONUS)) 

#calculo com montador

PAG_G139_0622_MONTADOR <- data.frame(CPF=c("88717020930"),BONUS=(CP_G139_0622 %>% 
                                                                   summarize(BONUS=sum(VRVENDA)*0.03))) 


PAG_G139_0622 <- rbind(PAG_G139_0622_VENDEDORAS,PAG_G139_0622_MONTADOR) %>%  mutate(OBS=OBS_G139)

View(PAG_G139_0622)

PAG_G139_0622 %>% summarize(BONUS=sum(BONUS)) 
...
CP_849_0622 %>% summarize(v=sum(VRVENDA))

CP_849_0622 %>% summarize(v=sum(VRVENDA)*0.08)

## OBS
OBS_849 <-paste0("VITAL ","G",CP_849_0622  %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))



## LISTA PEDIDOS
LIST_849_0622 <- CP_849_0622 %>% 
  mutate(CPF=rep(c("04455447911","06532582913"), length.out=nrow(CP_849_0622))) %>% 
  mutate(OBS=OBS_849)
...
PAG_849_0622 <- LIST_849_0622 %>% group_by(CPF) %>% 
...
CP_157_0622 %>% summarize(v=sum(VRVENDA))

CP_157_0622 %>% summarize(v=sum(VRVENDA)*0.1)

## OBS

OBS_157 <- paste0("DOM BOSCO ","G",CP_157_0622  %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


## JOIN CPF

LIST_157_0622 <- inner_join(CP_157_0622,BASE_CPF,by="CLICODIGO") %>% 
...
LIST_157_0622 %>% summarize(v=sum(BONUS))


## PAY

PAG_157_0622 <- LIST_157_0622 %>% group_by(CPF) %>% summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_157) 
...
CP_1419_0622 %>% summarize(v=sum(BONUS))

## OBS


OBS_1419 <- paste0("LOOK ",CP_1419_0622  %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


## JOIN CPF

LIST_1419_0622 <- inner_join(CP_1419_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1419)
...
PAG_1419_0622 <- LIST_1419_0622 %>%  group_by(CPF) %>% 
...
CP_305_0622 %>% summarize(v=sum(BONUS))


## OBS

OBS_305 <- paste0("GARUVA ",CP_305_0622 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))


## JOIN CPF

LIST_305_0622 <- inner_join(CP_305_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_305)
...
LIST_305_0622 %>% summarize(v=sum(BONUS))


### pagamentos

PAG_305_0622 <- LIST_305_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_305) 
...
PAG_305_0622 %>% summarize(v=sum(BONUS)) 
...
CP_G121_0622 %>% summarize(v=sum(VRVENDA))

CP_G121_0622 %>% summarize(v=sum(BONUS))


## OBS

OBS_G121 <- paste0("RINALDI ","G",CP_G121_0622 %>% 
                     distinct(GCLCODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G121_0622 <- inner_join(CP_G121_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G121)
...
PAG_G121_0622 <- LIST_G121_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>%
  mutate(OBS=OBS_G121) 
...
PAG_G121_0622 %>% summarize(v=sum(BONUS))
...
CP_206_0622 %>% summarize(v=sum(VRVENDA))

CP_206_0622 %>% summarize(v=sum(BONUS))


OBS_206 <-  paste0("OTICA RH ",CP_206_0622 %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 

## JOIN CPF

LIST_206_0622 <- inner_join(CP_206_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_206)
...
PAG_206_0622 <- LIST_206_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_206)
...
CP_213_0622 %>% summarize(v=sum(BONUS))

## OBS

OBS_213 <- paste0("LINO ",CP_213_0622 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y"))

## JOIN CPF AND LIST

LIST_213_0622 <- inner_join(CP_213_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  mutate(OBS=OBS_213) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") 
...
LIST_213_0622_2 <- LIST_213_0622 %>% distinct(.,ID_PEDIDO,.keep_all = TRUE)


## PAY

PAG_213_0622<-  LIST_213_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=sum(BONUS)/(LIST_213_0622  %>% distinct(CPF) %>% lengths())) %>% 
  mutate(OBS=OBS_213) 
...
CP_1225_0622 %>% summarize(v=sum(VRVENDA))

CP_1225_0622 %>% summarize(v=sum(BONUS))

OBS_1225 <- paste0("VINI ",CP_1225_0622 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_1225_0622  <- inner_join(CP_1225_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1225)
...
PAG_1225_0622 <- LIST_1225_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_1225) 
...
CP_1676_0622 %>% summarize(v=sum(VRVENDA))

CP_1676_0622 %>% summarize(v=sum(BONUS))

OBS_1676 <- paste0("ORBEN ",CP_1676_0622 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_1676_0622  <- inner_join(CP_1676_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1676)
...
PAG_1676_0622 <- LIST_1676_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_1676) 
...
PAG_1676_0622 %>% summarize(v=sum(BONUS))
...
CP_350_0622 %>% summarize(v=sum(VRVENDA))

CP_350_0622 %>% summarize(v=sum(BONUS))

OBS_350 <- paste0("SANTA LUZIA ",CP_350_0622 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_350_0622  <- inner_join(CP_350_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_350)
...
PAG_350_0622 <- LIST_350_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_350) 
...
PAG_350_0622 %>% summarize(v=sum(BONUS))
...
CP_788_0622 %>% summarize(v=sum(VRVENDA))

CP_788_0622 %>% summarize(v=sum(BONUS))

OBS_788 <- paste0("ASTRO ",CP_788_0622 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_788_0622  <- inner_join(CP_788_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_788)
...
PAG_788_0622 <- LIST_788_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_788) 
...
PAG_788_0622 %>% summarize(v=sum(BONUS))
...
CP_325_0622 %>% summarize(v=sum(VRVENDA))

CP_325_0622 %>% summarize(v=sum(BONUS))

OBS_325 <- paste0("MIAMI ",CP_325_0622 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_325_0622  <- inner_join(CP_325_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_325)
...
PAG_325_0622 <- LIST_325_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_325) 
...
PAG_325_0622 %>% summarize(v=sum(BONUS))

## =============================================================================================================         

# SQL G187 CRAFTS

CP_G187_0622 <- dbGetQuery(con2,"
WITH FIS AS (SELECT FISCODIGO FROM TBFIS WHERE FISTPNATOP IN ('V','SR','R')),
...
CP_G187_0622 %>% summarize(v=sum(VRVENDA))

CP_G187_0622 %>% summarize(v=sum(BONUS))

OBS_G187 <- paste0("CRAFTS ",CP_G187_0622 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G187_0622  <- inner_join(CP_G187_0622,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G187)
...
PAG_G187_0622 <- LIST_G187_0622 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G187) 
...
PAG_G187_0622 %>% summarize(v=sum(BONUS))
...
range_write(PAG_ALL_0622,ss="1yEv5jjVjcm33wO5pcrdNqzEy5UGQ2bTa39vjmeEzWSE",range = "A1",sheet="PAGAMENTOS",reformat = FALSE)  
...
LIST_ALL_0622 %>% summarize(v=sum(BONUS))

range_write(LIST_ALL_0622,ss="1yEv5jjVjcm33wO5pcrdNqzEy5UGQ2bTa39vjmeEzWSE",range = "A:P",sheet="PEDIDOS",reformat = FALSE)  

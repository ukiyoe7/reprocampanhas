...
View(CP_G139_0922)
CP_G139_0922 %>%  summarize(v=sum(VRVENDA)) # total sales
CP_G139_0922 %>%  summarize(v=sum(VRVENDA)*0.07) # vendedoras 
CP_G139_0922 %>%  summarize(v=sum(VRVENDA)*0.03) # montador
sum(CP_G139_0922 %>%  summarize(v=sum(VRVENDA)*0.07),CP_G139_0922 %>% summarize(v=sum(VRVENDA)*0.03)) #total

## OBS

OBS_G139 <- paste0("SCHROEDER ","G",CP_G139_0922 %>% 
                     distinct(GCLCODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y"))


### Cria Planilha identificação CPFs

CP_G139_0922_IPEDIDOS <- CP_G139_0922 %>% group_by(ID_PEDIDO,PEDDTBAIXA) %>% 
  summarize(VRVENDA=sum(VRVENDA)) %>% 
  as.data.frame() %>% `colnames<-`(c("ID_PEDIDO","DATA","VALOR.VENDA")) %>% 
  mutate(DATA=format(DATA,"%d/%m/%y")) 

range_write("13eyIBalP4EQqfoM4ai0M4Uxb2knX6Lz-cJHBCqWccNE",data=CP_G139_0922_IPEDIDOS,sheet = "SET22",
            range = "A1") 


View(CP_G139_0922_IPEDIDOS)

## obtem dados planilha identificação CPFs


CPF_G139_CPF_0922 <- read_sheet("13eyIBalP4EQqfoM4ai0M4Uxb2knX6Lz-cJHBCqWccNE",sheet = "SET22") %>% 
  as.data.frame() %>% 
  mutate(CPF=sub("\\D+", '',CPF)) %>% 
  mutate(CPF=sub("\\.", '',CPF)) %>% 
  mutate(CPF=sub("\\-", '',CPF))

View(CPF_G139_CPF_0922)


#lista pedidos

LIST_G139_0922 <- inner_join(CP_G139_0922,CPF_G139_CPF_0922,by="ID_PEDIDO") %>% 
  mutate(OBS=OBS_G139) %>% 
  .[,c(-12,-13,-14)]

View(LIST_G139_0922)

LIST_G139_0922 %>% summarize(BONUS=sum(BONUS)) 
...
PAG_G139_0922_VENDEDORAS <- LIST_G139_0922 %>% group_by(CPF) %>% summarize(BONUS=sum(BONUS)) 

#calculo com montador

PAG_G139_0922_MONTADOR <- data.frame(CPF=c("88717020930"),BONUS=(CP_G139_0922 %>% 
                                                                   summarize(BONUS=sum(VRVENDA)*0.03))) 


PAG_G139_0922 <- rbind(PAG_G139_0922_VENDEDORAS,PAG_G139_0922_MONTADOR) %>%  mutate(OBS=OBS_G139) %>% 
  mutate(BONUS=round(BONUS,0))

View(PAG_G139_0922)

PAG_G139_0922 %>% summarize(BONUS=sum(BONUS)) 
           ...
           PROCODIGO,
            PDPDESCRICAO,
             PEDAUTORIZOU,
              SUM(PDPQTDADE) QTD,
               SUM(PDPUNITLIQUIDO*PDPQTDADE)VRVENDA,
                SUM(PDPUNITLIQUIDO*PDPQTDADE)*0.03 BONUS
                 FROM
                 PDPRD
                 INNER JOIN PD ON PDPRD.ID_PEDIDO=PD.ID_PEDIDO
                 GROUP BY 1,2,3,4,5,6,7,8") 
...
CP_849_0922 %>% summarize(v=sum(VRVENDA))

CP_849_0922 %>% summarize(v=sum(VRVENDA)*0.08)

## OBS
OBS_849 <-paste0("VITAL ","G",CP_849_0922  %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y"))



## LISTA PEDIDOS
LIST_849_0922 <- CP_849_0922 %>% 
  mutate(CPF=rep(c("04455447911","06532582913"), length.out=nrow(CP_849_0922))) %>% 
  mutate(OBS=OBS_849)
...
PAG_849_0922 <- LIST_849_0922 %>% group_by(CPF) %>% 
...
CP_157_0922 %>% summarize(v=sum(VRVENDA))

CP_157_0922 %>% summarize(v=sum(VRVENDA)*0.1)

## OBS

OBS_157 <- paste0("DOM BOSCO ","G",CP_157_0922  %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y"))


## JOIN CPF

LIST_157_0922 <- inner_join(CP_157_0922,BASE_CPF,by="CLICODIGO") %>% 
...
LIST_157_0922 %>% summarize(v=sum(BONUS))


## PAY

PAG_157_0922 <- LIST_157_0922 %>% group_by(CPF) %>% summarize(BONUS=round(sum(BONUS),0)) %>% 
  mutate(OBS=OBS_157) 
...
CP_1419_0922 %>% summarize(v=sum(BONUS))

## OBS


OBS_1419 <- paste0("LOOK ",CP_1419_0922  %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y"))


## JOIN CPF

LIST_1419_0922 <- inner_join(CP_1419_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1419)
...
PAG_1419_0922 <- LIST_1419_0922 %>%  group_by(CPF) %>% 
...
CP_305_0922 %>% summarize(v=sum(BONUS))


## OBS

OBS_305 <- paste0("GARUVA ",CP_305_0922 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y"))


## JOIN CPF

LIST_305_0922 <- inner_join(CP_305_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_305)
...
LIST_305_0922 %>% summarize(v=sum(BONUS))


### pagamentos

PAG_305_0922 <- LIST_305_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_305) 
...
PAG_305_0922 %>% summarize(v=sum(BONUS)) 
...
CP_G121_0922 %>% summarize(v=sum(VRVENDA))

CP_G121_0922 %>% summarize(v=sum(BONUS))


## OBS

OBS_G121 <- paste0("RINALDI ","G",CP_G121_0922 %>% 
                     distinct(GCLCODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y")) 


## JOIN CPF

LIST_G121_0922 <- inner_join(CP_G121_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G121)
...
PAG_G121_0922 <- LIST_G121_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>%
  mutate(OBS=OBS_G121) 
...
PAG_G121_0922 %>% summarize(v=sum(BONUS))
...
CP_206_0922 %>% summarize(v=sum(VRVENDA))

CP_206_0922 %>% summarize(v=sum(BONUS))


OBS_206 <-  paste0("OTICA RH ",CP_206_0922 %>% distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y")) 

## JOIN CPF

LIST_206_0922 <- inner_join(CP_206_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_206)
...
PAG_206_0922 <- LIST_206_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_206)
...
CP_1225_0922 %>% summarize(v=sum(VRVENDA))

CP_1225_0922 %>% summarize(v=sum(BONUS))

OBS_1225 <- paste0("VINI ",CP_1225_0922 %>% 
                     distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m%y")) 


## JOIN CPF

LIST_1225_0922  <- inner_join(CP_1225_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_1225)
...
PAG_1225_0922 <- LIST_1225_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_1225) 
...
PAG_1225_0922 %>% summarize(v=sum(BONUS))
...
CP_G121_2_0922 <- dbGetQuery(con2,"
WITH FIS AS (SELECT FISCODIGO FROM TBFIS WHERE FISTPNATOP IN ('V','SR','R')),
...
CP_G121_2_0922 %>% summarize(v=sum(VRVENDA))

CP_G121_2_0922 %>% summarize(v=sum(BONUS))
...
LIST_G121_2_0922  <- CP_G121_2_0922 %>%   mutate(OBS=OBS_G121_2)

View(LIST_G121_2_0922)


### PAY

PAG_G121_2_0922 <- LIST_G121_2_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G121_2) 

View(PAG_G121_2_0922)


PAG_G121_2_0922 %>% summarize(v=sum(BONUS))
...
CP_G224_0922 %>% summarize(v=sum(VRVENDA))

CP_G224_0922 %>% summarize(v=sum(BONUS))

## OBSERV

OBS_G224 <- paste0("ITACU ","G",CP_G224_0922 %>% 
                     distinct(GCLCODIGO), " ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G224_0922  <- inner_join(CP_G224_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G224)
...
PAG_G224_0922 <- LIST_G224_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G224) 
...
PAG_G224_0922 %>% summarize(v=sum(BONUS))
...
CP_G77_0922 %>% summarize(v=sum(VRVENDA))

CP_G77_0922 %>% summarize(v=sum(BONUS))

## OBSERV

OBS_G77 <- paste0("DANJU ","G",CP_G77_0922 %>% 
                    distinct(GCLCODIGO), " ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_G77_0922  <- inner_join(CP_G77_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G77)
...
PAG_G77_0922 <- LIST_G77_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G77) 
...
PAG_G77_0922 %>% summarize(v=sum(BONUS))
...
CP_360_0922 %>% summarize(v=sum(VRVENDA))

CP_360_0922 %>% summarize(v=sum(BONUS))

OBS_360 <- paste0("UNIVERSAL ",CP_360_0922 %>% 
                    distinct(CLICODIGO)," ",format(floor_date(Sys.Date()-months(1),"month"),"%m/%y")) 


## JOIN CPF

LIST_360_0922  <- inner_join(CP_360_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_360)
...
PAG_360_0922 <- LIST_360_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_360) 
...
PAG_360_0922 %>% summarize(v=sum(BONUS))
## ====================================================================================================
...
CP_G37_0922 %>% summarize(v=sum(VRVENDA))
...
LIST_G37_0922  <- inner_join(CP_G37_0922,BASE_CPF,by="CLICODIGO") %>% 
  rename(CPF1=CPF.x) %>% rename(CPF2=CPF.y) %>% 
  .[,-12] %>% 
  rename(.,"CPF"="CPF2") %>% 
  mutate(OBS=OBS_G37_0922)
...
PAG_G37_0922 <- LIST_G37_0922 %>% group_by(CPF) %>% 
  summarize(BONUS=round(sum(BONUS),2)) %>% 
  mutate(OBS=OBS_G37_0922 ) 
...
range_write(PAG_ALL_0922,ss="1tF9por2Q4mrXJvDm0hh8ta3T3EmSXkGqQ0Xc1K9efmY",range = "A1",sheet="PAGAMENTOS",reformat = FALSE)  
...
LIST_ALL_0922 %>% summarize(v=sum(BONUS))

range_write(LIST_ALL_0922,ss="1tF9por2Q4mrXJvDm0hh8ta3T3EmSXkGqQ0Xc1K9efmY",range = "A:P",sheet="PEDIDOS",reformat = FALSE)  

## ==============================================================================================================
## CREDITO CARTOES

CREDITO_CARTOES_0922 <- left_join(PAG_ALL_0922 %>%
                                      mutate(CPF=as.character(CPF)),CARTOES_0922,by="CPF") 


View(CREDITO_CARTOES_0922)



CREDITO_CARTOES_0922_2 <- CREDITO_CARTOES_0922 %>% 
  filter(!is.na(NSERIE))

View(CREDITO_CARTOES_0922_2)

CREDITO_CARTOES_0922_3 <- CREDITO_CARTOES_0922_2 %>% 
                                   .[,c(7,1,2,3)] %>% 
                                     rename_at(1:4, ~ c("Número de Série","CPF","Valor da Carga","Observacao"))


View(CREDITO_CARTOES_0922_3)  

CREDITO_CARTOES_0922_3 %>% summarize(v=sum(`Valor da Carga`))

CREDITO_CARTOES_0922_3 %>% .[duplicated(.$CPF),]


write.csv2(CREDITO_CARTOES_0922_3,
           file = "C:\\Users\\Repro\\Documents\\R\\ADM\\CAMPANHAS_REPRO\\SET\\CREDITO_CARTOES_0922.csv",

...
range_write(PAG_INSIGNE_1122_ALL,ss="1OTNU8i8AU_ot8NDgkPKfAd65-nrKUTDiS5Tqz9il3Vo",range = "A22",
...
View(CREDITO_CARTOES_INSIGNE_1122)
...
CREDITO_CARTOES_INSIGNE_1122_3 <- CREDITO_CARTOES_INSIGNE_1122 %>% 
...
CREDITO_CARTOES_INSIGNE_1122_5 <- CREDITO_CARTOES_INSIGNE_1122_4 %>% 
  .[,c(5,1,2,3)] %>% 
  rename_at(1:4, ~ c("Número de Série","CPF","Valor da Carga","Observacao"))


View(CREDITO_CARTOES_INSIGNE_1122_5)  

CREDITO_CARTOES_INSIGNE_1122_5 %>% summarize(v=sum(`Valor da Carga`))

CREDITO_CARTOES_INSIGNE_1122_5 %>% .[duplicated(.$CPF),]


write.csv2(CREDITO_CARTOES_INSIGNE_1122_5,
